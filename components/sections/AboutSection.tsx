...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section id="about" className="py-28 border-t border-white/[0.04]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <BentoCard className="lg:col-span-2 p-8 sm:p-10" hoverEffect={false}>
            <div className="space-y-5 text-[#999999] text-[15px] sm:text-[16px] font-normal leading-[1.75]">
              ...
              <div className="flex flex-wrap items-center gap-3">
                {languages.map((lang, idx) => (
                  ...
                  >
                    ...
                    {idx < languages.length - 1 && <span className="text-neutral-700 ml-3">•</span>}
                  </span>
                ))}
              </div>
            </div>
          ...
          <BentoCard className="p-8 sm:p-10 flex flex-col justify-between" hoverEffect={false}>
            <div>
              ...
              <h3 className="text-lg font-semibold text-[#EEEEEE] mb-3 leading-snug tracking-[-0.01em]">
            ...
            <div className="mt-10 pt-6 border-t border-white/[0.05]">
              <a
                href="#contact"
                className="w-full py-3 px-4 rounded-[12px] bg-[rgba(255,255,255,0.04)] hover:bg-[rgba(255,255,255,0.08)] border border-white/[0.06] text-[#EEEEEE] flex items-center justify-center text-xs font-medium tracking-[0.08em] uppercase transition-colors"
              >
                Contact Aditya
              </a>
            </div>
        ...
        <div className="mt-6">
          <BentoCard className="p-8 sm:p-10" hoverEffect={false}>
            <div className="mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-4">
              {professionalHighlights.map((highlight, idx) => (
                <div
                  key={idx}
                  className="flex items-start gap-3 text-xs sm:text-[14px] font-normal text-[#EEEEEE] leading-[1.6]"
                >
